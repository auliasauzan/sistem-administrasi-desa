<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('resident.update', $resident) }}" method="post" class="form">
            @csrf
            @method('put')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-default @error('family_id') is-invalid @enderror" id="family_id" name="family_id" required>
                            ...
                            @foreach($families as $family)
                                <option value="{{ $family->id }}" @selected(old('family_id', $resident->family_id) == $family->id)>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('national_id') is-invalid  @enderror" type="text" id="national_id"
                            name="national_id" required value="{{ old('national_id', $resident->national_id) }}">
                        @error('national_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('full_name') is-invalid  @enderror" type="text" id="full_name"
                            name="full_name" required value="{{ old('full_name', $resident->full_name) }}">
                        @error('full_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('birth_date') is-invalid  @enderror" type="date" id="birth_date"
                            name="birth_date" required value="{{ old('birth_date', $resident->birth_date) }}">
                        @error('birth_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('occupation') is-invalid  @enderror" type="text" id="occupation"
                            name="occupation" required value="{{ old('occupation', $resident->occupation) }}">
                        @error('occupation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
