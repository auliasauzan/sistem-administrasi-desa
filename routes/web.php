...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/user', UserController::class)->middleware('role:Admin Desa');
    ...
    Route::resource('/land_certificate', \App\Http\Controllers\LandCertificateController::class);
